...
// JJS replaced all Touchables with Pressable
import {
  View,
  SafeAreaView,
  // TouchableOpacity,
...
const defaultColors = {
  ...
  chipColor: '#848787',
  // modified by JJS to solve the background color when we set a margin:showing the white
  // itemBackground: '#fff',
...
// JJS replaced all Touchables with Pressable
  ...
  BackdropView = ({ children, ...props }) => {
    ...
    const Wrapper = modalWithTouchable ? Pressable : null
        ...
        >
          <this.ModalContentWrapper>
            ...
            >
                  ...
                  {loading ? (
                    ...
                    <View>
                      ...
                      {items && renderItems && renderItems.length ? (
                        <View>
                          <FlatList
                          // JJS modified the showsVerticalScrollIndicator
              ...
              {/* JJS modified:Added this View as a container for the buttons section
              in order to let the width of this sectio follow the width requested
              on orientation change and on both phone and tablet */}
              ...
              <View style={{ flexDirection: 'row',justifyContent:'space-between'}}>
                {showCancelButton && (
                  <Touchable
                    ...
                    // JJs modified: added this style
                    style={{ flex: 1 }} >
                    <View
                      style={[
                        {
                          //JJS modified:commented this width to allow flexibility
                          // width: 54,
                          // JJS modified:when all subitems are unselected the cancel button shrinks
